...
//Function SPI_InitDevice (ftHandle:Dword ;ClockDivisor:Dword): Dword;
Function iniciarSPI :       FT_Result;
...
Function SPI_InitDevice(ftHandle:Dword ;ClockDivisor:Dword) : Dword     ; stdcall ;  External 'FTCSPI.dll' name 'SPI_InitDevice';
...
function iniciarSPI : FT_Result ;
     Begin
FT_IO_Status :=  SPI_InitDevice(FT_Handle,2) ;

If FT_IO_Status <> FT_OK then FT_Error_Report('Init',FT_IO_Status);
